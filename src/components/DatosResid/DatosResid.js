        ...
        <div className="col-12 col-md-12 mb-1">
          ...
          <div className="col-12 col-md-12 mb-1">
                ...
                <div class="form-floating">
                    <select class="form-select ng-not-empty ng-dirty ng-valid-parse ng-valid ng-valid-required ng-touched" id="Estrato" name="Estrato" aria-label="Estrato" ng-model="Data.solicitante.residencia.Estrato" required="">
